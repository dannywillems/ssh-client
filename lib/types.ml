...
type ssh_error_code = SSH_OK | SSH_ERROR | SSH_AGAIN | SSH_EOF
...
let ssh_option_to_string =
  ...
  | SSH_OPTIONS_STRICTHOSTKEYCHECK b ->
      pr "SSH_OPTIONS_STRICTHOSTKEYCHECK(%B)" b
  ...
  | SSH_OPTIONS_GSSAPI_SERVER_IDENTITY s ->
      pr "SSH_OPTIONS_GSSAPI_SERVER_IDENTITY(%s)" s
  | SSH_OPTIONS_GSSAPI_CLIENT_IDENTITY s ->
      pr "SSH_OPTIONS_GSSAPI_CLIENT_IDENTITY(%s)" s
  | SSH_OPTIONS_GSSAPI_DELEGATE_CREDENTIALS b ->
      pr "SSH_OPTIONS_GSSAPI_DELEGATE_CREDENTIALS(%B)" b
